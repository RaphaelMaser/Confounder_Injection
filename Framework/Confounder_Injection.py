        ...
        for i in range(0, epochs):
            ...
            for cf_var in range(0,len(self.index)):
                ...
                if wandb_init != None and (i % 100) == 0:
                    wandb.log({"classification_accuracy":classification_accuracy, "confounder_accuracy":confounder_accuracy, "confounder_strength":self.index[cf_var], "epoch":i+1}, commit=True)
                elif wandb_init != None and (i % 10) == 0:
                    wandb.log({"classification_accuracy":classification_accuracy, "confounder_accuracy":confounder_accuracy, "confounder_strength":self.index[cf_var], "epoch":i+1}, commit=False)
