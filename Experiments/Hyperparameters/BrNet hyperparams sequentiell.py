...
def train_tune(config, checkpoint_dir=None):
    ...
    if finetuning:
        ...
        c = CI.confounder()
        c.generate_data(mode="br_net", samples=0, target_domain_samples=target_domain_samples, test_samples=8, target_domain_confounding=target_domain_confounding, train_confounding=1, test_confounding=[test_confounding], de_correlate_confounder_target=de_correlate_confounder_target, de_correlate_confounder_test=de_correlate_confounder_test, params=params)
    ...
    # standard routine
        ...
        c = CI.confounder()
        c.generate_data(mode="br_net", samples=512, target_domain_samples=target_domain_samples, test_samples=8, target_domain_confounding=target_domain_confounding, train_confounding=1, test_confounding=[test_confounding], de_correlate_confounder_target=de_correlate_confounder_target, de_correlate_confounder_test=de_correlate_confounder_test, params=params)
